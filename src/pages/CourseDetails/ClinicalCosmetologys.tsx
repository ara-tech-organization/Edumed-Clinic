...
import ClinicalCosmetologys from "@/assets/Clinical-Cosmetology.png";
...
const ClinicalCosmetology: React.FC = () => {
...
export default ClinicalCosmetology;
